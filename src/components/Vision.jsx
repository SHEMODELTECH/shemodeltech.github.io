  ...
  return (
    <div name='vision' className="bg-white z-20 relative" >
        <Container className={'py-20 lg:py-32'}>
          ...
          data-aos-easing='linear'
          data-aos-duration='900'>Our vision is to foster diversity and enable women to excel and thrive in the technology sector by providing access to IT skills training, mentorship, leadership development, and networking opportunities.</p>
                </div>
